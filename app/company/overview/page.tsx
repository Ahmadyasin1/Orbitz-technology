    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          ...
          {/* Mission, Vision, and Core Value Cards - Fill White Space */}
          <div className="flex flex-col gap-8 justify-between h-full">
            <div className="flex flex-row gap-6 items-stretch">
              <Card className="flex-1 p-8 shadow-lg border-0 bg-gradient-to-br from-purple-50 via-white to-pink-50 flex flex-col justify-center">
              ...
              <Image src="/modern-data-center.png" alt="Mission" width={220} height={140} className="rounded-xl shadow-lg object-cover" />
            </div>
            <div className="flex flex-row gap-6 items-stretch">
              <Image src="/modern-office-colorful-lighting.png" alt="Vision" width={220} height={140} className="rounded-xl shadow-lg object-cover" />
              <Card className="flex-1 p-8 shadow-lg border-0 bg-gradient-to-br from-pink-50 via-white to-purple-50 flex flex-col justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <Card className="p-8 shadow-lg flex flex-col items-center text-center border-0 bg-white">
              <Image src="/chipmath-high-tech-community-logo.png" alt="Excellence" width={60} height={60} className="mb-4" />
            ...
            <Card className="p-8 shadow-lg flex flex-col items-center text-center border-0 bg-white">
              <Image src="/aws.png" alt="Collaboration" width={60} height={60} className="mb-4" />
            ...
            <Card className="p-8 shadow-lg flex flex-col items-center text-center border-0 bg-white">
              <Image src="/privacy-evolved-logo.png" alt="Integrity" width={60} height={60} className="mb-4" />
            ...
            <Card className="p-8 shadow-lg flex flex-col items-center text-center border-0 bg-white">
              <Image src="/google.png" alt="Adaptability" width={60} height={60} className="mb-4" />
            ...
            <Card className="p-8 shadow-lg flex flex-col items-center text-center border-0 bg-white">
              <Image src="/nexustek-logo.png" alt="Empowerment" width={60} height={60} className="mb-4" />
            ...
            <Card className="p-8 shadow-lg flex flex-col items-center text-center border-0 bg-white">
              <Image src="/weave-logo.png" alt="Authenticity" width={60} height={60} className="mb-4" />
