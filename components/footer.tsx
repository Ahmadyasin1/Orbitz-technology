			...
			<div className="max-w-7xl mx-auto px-4">
				<div className="grid grid-cols-1 md:grid-cols-6 gap-0 items-start">
					...
					<div className="md:col-span-1 flex flex-col pl-8">
						...
						<ul className="space-y-2">
							<li><Link href="/industries/education" className="text-gray-400 hover:text-white transition-colors text-sm">Education</Link></li>
							<li><Link href="/industries/financial" className="text-gray-400 hover:text-white transition-colors text-sm">Financial</Link></li>
							<li><Link href="/industries/healthcare" className="text-gray-400 hover:text-white transition-colors text-sm">Healthcare</Link></li>
							<li><Link href="/industries/legal" className="text-gray-400 hover:text-white transition-colors text-sm">Legal</Link></li>
							...
							<li><Link href="/industries/real-estate" className="text-gray-400 hover:text-white transition-colors text-sm">Real Estate</Link></li>
						</ul>
					</div>
					<div className="md:col-span-1 flex flex-col pl-8">
						...
						<ul className="space-y-2">
							...
							<li><Link href="/resources/webinars" className="text-gray-400 hover:text-white transition-colors text-sm">Webinars</Link></li>
							<li><Link href="/resources/whitepapers" className="text-gray-400 hover:text-white transition-colors text-sm">Whitepapers</Link></li>
						</ul>
					</div>
					<div className="md:col-span-1 flex flex-col pl-8">
