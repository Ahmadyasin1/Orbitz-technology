				...
				<div className="grid grid-cols-1 md:grid-cols-6 gap-0 items-start">
					...
					<div className="md:col-span-2 flex flex-col justify-start pr-8 border-r border-gray-800">
						...
						<p className="text-gray-400 text-sm mb-4 max-w-xs">
							Empowering Small & Mid-Sized Businesses with Scalable Managed IT Services, Industry-Specific Expertise, and Custom Development in Cybersecurity Solutions, Cloud Infrastructure, AI Solutions, and Enterprise Software Development.
						</p>
						{/* Social Media Links */}
					...
					<div className="md:col-span-1 flex flex-col pl-8">
						...
						<ul className="space-y-2">
							<li><a href="/services/managed-it" className="text-gray-400 hover:text-white transition-colors text-sm">Managed IT Services</a></li>
							...
							<li><a href="/services/technology-advisory" className="text-gray-400 hover:text-white transition-colors text-sm">Technology Advisory</a></li>
							<li><a href="/services/ai-development" className="text-gray-400 hover:text-white transition-colors text-sm">AI Development</a></li>
							<li><a href="/services/cybersecurity" className="text-gray-400 hover:text-white transition-colors text-sm">Cyber Security</a></li>
						</ul>
					</div>
					<div className="md:col-span-1 flex flex-col pl-8">
						<h4 className="text-lg font-semibold mb-3">Markets</h4>
						<ul className="space-y-2">
							<li><a href="/industries/education" className="text-gray-400 hover:text-white transition-colors text-sm">Education</a></li>
							<li><a href="/industries/financial" className="text-gray-400 hover:text-white transition-colors text-sm">Financial</a></li>
							<li><a href="/industries/healthcare" className="text-gray-400 hover:text-white transition-colors text-sm">Healthcare</a></li>
							<li><a href="/industries/legal" className="text-gray-400 hover:text-white transition-colors text-sm">Legal</a></li>
							<li><a href="/industries/manufacturing" className="text-gray-400 hover:text-white transition-colors text-sm">Manufacturing</a></li>
							<li><a href="/industries/real-estate" className="text-gray-400 hover:text-white transition-colors text-sm">Real Estate</a></li>
						</ul>
					</div>
					<div className="md:col-span-1 flex flex-col pl-8">
						...
						<ul className="space-y-2">
							...
							<li><a href="/resources/case-studies" className="text-gray-400 hover:text-white transition-colors text-sm">Case Studies</a></li>
							<li><a href="/resources/webinars" className="text-gray-400 hover:text-white transition-colors text-sm">Webinars</a></li>
							<li><a href="/resources/whitepapers" className="text-gray-400 hover:text-white transition-colors text-sm">Whitepapers</a></li>
						</ul>
					</div>
					<div className="md:col-span-1 flex flex-col pl-8">
						...
						<ul className="space-y-2">
							...
							<li><a href="/company/overview" className="text-gray-400 hover:text-white transition-colors text-sm">Overview</a></li>
							<li><a href="/company/our-approach" className="text-gray-400 hover:text-white transition-colors text-sm">Our Approach</a></li>
							<li><a href="/company/our-partners" className="text-gray-400 hover:text-white transition-colors text-sm">Our Partners</a></li>
