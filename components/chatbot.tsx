      ...
      <div className="fixed bottom-6 right-6 z-50">
        {!isOpen && (
          <Button
            ...
            className="rounded-full w-16 h-16 bg-white border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center group relative"
          >
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-end">
          ...
          <Card className={`relative transition-all duration-300 shadow-lg border border-gray-200 bg-white ${
            isMinimized 
              ? 'w-64 h-12' 
              : 'w-80 md:w-[340px] h-[420px] md:h-[440px]'
          } rounded-xl m-8`}>
            ...
            {!isMinimized && (
              <CardContent className="p-0 flex flex-col h-[320px] md:h-[340px]">
                {/* Messages Area */}
                ...
                <div className="p-3 border-t bg-white rounded-b-xl">
                  ...
                  <div className="flex flex-wrap gap-1 mt-2">
                    <Button
                      ...
                      className="text-xs border-blue-100 text-blue-500 hover:bg-blue-50 rounded-full px-2 py-0.5 font-normal"
                    >
                      About Orbitz
                    </Button>
                    <Button
